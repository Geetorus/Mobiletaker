...
def check_packages():
    ...
    if (
        ...
        choice = input(
            f"\n{color.GREEN}Do you still want to continue to Mobiletaker Pro?{color.WHITE}     Y / N > "
        ).lower()
        if choice == "y" or choice == "":
            return
        elif choice == "n":
            exit_Mobiletaker_pro()
            return
        else:
...
def exit_Mobiletaker_pro():
    global run_Mobiletaker_pro
    run_Mobiletaker_pro = False
    print("\nExiting...\n")
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to Mobiletaker-Pro/{screenshot_location}\n{color.WHITE}"
        )
    else:
        print(
...
def screenrecord():
    ...
    if screenrecord_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving video to Mobiletaker-Pro/{screenrecord_location}\n{color.WHITE}"
        )
    else:
...
def pull_file():
    ...
    if pull_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving file to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving data to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_screenshots():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Screenshots to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_camera():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Photos to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def open_link():
    print(
        f"\n{color.YELLOW}Enter URL              {color.CYAN}Example :https://github.com/Unkownboy0/Mobiletaker.git{color.WHITE}"
    )
    url = input("> ")
...
def dump_sms():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving SMS file to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_contacts():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Contacts file to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_call_logs():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Call Logs file to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
        print(
...
def extract_apk():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving APK file to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
def update_me():
    print(f"{color.YELLOW}\nUpdating Mobiletaker-Pro\n{color.WHITE}")
    print(f"{color.GREEN}Fetching latest updates from GitHub\n{color.WHITE}")
    os.system("git fetch")
    print(f"{color.GREEN}\nApplying changes\n{color.WHITE}")
    os.system("git rebase")
    print(f"{color.CYAN}\nPlease restart Mobiletaker-Pro{color.WHITE}")
    exit_Mobiletaker_pro()


def visit_me():
    os.system(f"{opener} https://github.com/Unkownboy0/Mobiletaker.git")
    print("\n")
...
def record_audio(mode):
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving recordings to Mobiletaker-Pro/{pull_location}\n{color.WHITE}"
        )
    else:
...
if run_Mobiletaker_pro:
    clear_screen()
    while run_Mobiletaker_pro:
        try:
            main()
